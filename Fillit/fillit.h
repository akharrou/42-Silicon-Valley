...
/*   Updated: 2019/03/16 19:11:56 by akharrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define MAX_BOARD_ROW      35
# define MAX_BOARD_COL      35
# define MAX_NUM_PIECES     26
# define PIECE_ROWS         4
# define PIECE_COLS         4
# define PIECE_SIZE         20
# define BLOCKS_PER_PIECE   4
# define BOARD_START_SIZE   2
...
{
	t_char		matrix[MAX_BOARD_ROW][MAX_BOARD_COL];
	t_int8		rootsize;
}				t_board;

typedef struct	s_game
{
	t_piece		piece[MAX_NUM_PIECES];
	t_uint8		num_pieces;
	t_board		board;
}				t_game;
