...
/*
**    NAME
**         list_append_special -- adds a new element to the end of a list.
**
...
**
**         t_list *
**         list_append_special(t_list **head, t_list **tail, const void *item);
**
**    PARAMETERS
**
...
int		list_append_special(t_list **head, t_list **tail, const void *item)
{
	t_list	*probe;
	t_list	*new_elem;
